                    ...
                    <form method="post" action="{{route('Netflix.updateUsager', ['usager' => $usager->id])}}" class="formulaireAjoutFilm" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <input name="nom" type="text" class="form-control" id="nom" placeholder="Nom" name="nom" value="{{$usager->nom}}">
                            ...
                            <label class="text-light">Prénom</label>
                                <input type="text" class="form-control" id="prenom" placeholder="Prénom" name="prenom" value="{{$usager->prenom}}">
                                @if(isset($errors) && $errors->any())
                            ...
                            <label class="text-light">Nom d'usager</label>
                                <input type="text" class="form-control" id="lieu" placeholder="Nom d'usager" name="username" value="{{$usager->username}}">
                                @if(isset($errors) && $errors->any())
                            ...
                            <label class="text-light">Image de profil</label>
                                <input type="file" class="form-control" id="profil" name="profil" value="{{$usager->profil}}">
                                @if(isset($errors) && $errors->any())
                            ...
                            <label class="text-light">Email</label>
                                <input type="text" class="form-control" id="email" placeholder="Email" name="email" value="{{$usager->email}}">
                                @if(isset($errors) && $errors->any())
